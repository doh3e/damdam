      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 p-8 flex flex-col items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-1">
            <span className="font-semibold px-1.5 py-0.5 rounded bg-orange-100">
              {nickname?.trim() ? nickname : '회원'}
            </span>{' '}
            님, 반가워요!
          </h1>
        </div>
        ...
        <div className="w-full flex flex-col gap-3 mt-4">
          <Link
            ...
            className="py-3 rounded-xl text-center font-semibold text-white bg-[#e24b4b] hover:scale-105 transition duration-300"
          >
            사전설문 시작하기
          </Link>
          <Link
            href="/"
            className="py-3 rounded-xl text-center font-semibold bg-gray-200 hover:scale-105 transition duration-300"
          >
            건너뛰기
          </Link>
        </div>
